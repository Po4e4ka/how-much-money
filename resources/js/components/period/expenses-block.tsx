...
export const ExpensesBlock = ({
    ...
    >
        ...
        <div
            className={`mt-3 grid items-center gap-2 text-[11px] tracking-[0.2em] text-[#6a5d52] uppercase dark:text-white/60 ${
                showDelete
        ...
        >
            ...
            <span
                className={`font-display text-right text-sm tabular-nums ${
                    totalDifference > 0
                        ? 'text-[#1e7b4f] dark:text-[#7ce0b3]'
                        : totalDifference < 0
                          ? 'text-[#b0352b] dark:text-[#ff8b7c]'
