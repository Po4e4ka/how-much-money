...
export const OffIncomeBlock = ({
    ...
    <div
        ref={containerRef}
        className="w-full min-w-0 overflow-hidden rounded-lg border border-black/10 bg-white/80 px-4 py-4 text-sm shadow-[0_20px_40px_-26px_rgba(28,26,23,0.6)] sm:px-5 dark:border-white/10 dark:bg-white/10"
    >
                ...
                return (
                    ...
                    >
                        ...
                        <input
                            ...
                            className="no-spin w-full rounded-lg border border-black/10 bg-white/90 px-3 py-2 text-right text-xs text-[#b0352b] tabular-nums sm:px-4 sm:text-sm dark:border-white/10 dark:bg-white/10 dark:text-[#ff8b7c]"
                        />
                        {showDelete && (
                            <button
                                type="button"
        ...
        >
            ...
            <span className="font-display text-right text-sm text-[#b0352b] tabular-nums dark:text-[#ff8b7c]">
